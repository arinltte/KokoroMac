...
*   ⏸️ **Mathematically Exact Pauses:** Visual UI blocks for inserting precise pauses (Short, Medium, Long). The backend trims AI decay and splices exact digital silence for perfect audiobook pacing.
*   🗣️ **Phoneme Overrides:** Force exact pronunciations for tricky words or proper nouns using the International Phonetic Alphabet (IPA) without breaking text formatting.
...
*   📦 **One-Click Setup & Silent Updates:** Automatically provisions Python environments, installs dependencies, and downloads AI models. Upgrading to new versions automatically migrates backend scripts without requiring Terminal commands.
...
2.  **Add Directives:** Use the Speech Toolbox to insert visual Pause blocks (0.5s, 1.0s, 2.0s) or apply Phoneme Overrides for tricky pronunciations.
